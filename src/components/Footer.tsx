          ...
          <div className="relative z-10">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <button className="w-full sm:w-auto px-8 py-4 bg-emerald-900/40 hover:bg-emerald-900/60 backdrop-blur-md text-white font-bold rounded-2xl border border-white/20 transition-all hover:scale-105 active:scale-90">
                <a href="tel:0553882445">تواصل معنا: 0553882445</a>
              </button>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
            ...
            <div className="flex flex-col gap-6">
              ...
              <p className="text-gray-500 text-sm leading-relaxed font-medium">
                نسعى لتقديم أرقى خدمات الضيافة لضيوف الرحمن، مع باقات متنوعة تناسب كافة الاحتياجات.
              </p>

              <div className="flex flex-col gap-3">
                <a href="tel:0553882445" className="flex items-center gap-2 text-gray-700 hover:text-gold-dark transition-colors group">
                  ...
                  <span className="font-bold font-mono text-base" dir="ltr">055 388 2445</span>
                </a>
            ...
            {/* Col 2: About */}
            <div>
              <h4 className="font-bold text-gray-900 mb-6">عن الشركة</h4>
