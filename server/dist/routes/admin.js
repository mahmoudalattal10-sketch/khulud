...
// 📈 GET DASHBOARD STATS
// ============================================
router.get('/stats', auth_1.authMiddleware, auth_1.adminMiddleware, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const yearBookings = yield prisma.booking.findMany({
            where: {
                createdAt: {
                    gte: startOfYear,
                    lte: endOfYear
        ...
        const bookingsWithCity = yield prisma.booking.findMany({
        ...
        const makkahCount = bookingsWithCity.filter(b => { var _a, _b; return ((_b = (_a = b.room) === null || _a === void 0 ? void 0 : _a.hotel) === null || _b === void 0 ? void 0 : _b.city) === 'makkah'; }).length;
        const madinahCount = bookingsWithCity.filter(b => { var _a, _b; return ((_b = (_a = b.room) === null || _a === void 0 ? void 0 : _a.hotel) === null || _b === void 0 ? void 0 : _b.city) === 'madinah'; }).length;
...
// ============================================
router.get('/analytics', auth_1.authMiddleware, auth_1.adminMiddleware, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        for (let i = 6; i >= 0; i--) {
            ...
            const dayBookings = yield prisma.booking.findMany({
                where: {
                    createdAt: {
                        gte: startOfDay,
                        lte: endOfDay
        ...
        const activeBookingsAll = yield prisma.booking.findMany({
        ...
        const hotelPerformance = hotels.map(hotel => {
            ...
            if (occupancy < 30)
                ...
                color = 'bg-emerald-500'; // High occupancy
            return {
                name: hotel.name,
                val: `${occupancy}%`,
                rawVal: occupancy,
        ...
        users.forEach(u => {
            var _a;
            const p = ((_a = u.phone) === null || _a === void 0 ? void 0 : _a.replace(/\D/g, '')) || ''; // Remove non-digits
            if (p.startsWith('966') || p.startsWith('05')) {
                ksaCount++;
            }
            else if (p.startsWith('971') || // UAE
        ...
        if (ksaPct >= gulfPct && ksaPct >= intlPct)
            topSource = { name: 'المملكة العربية السعودية', pct: ksaPct };
        else if (gulfPct >= ksaPct && gulfPct >= intlPct)
            topSource = { name: 'دول الخليج', pct: gulfPct };
        else
            topSource = { name: 'الزوار الدوليين', pct: intlPct };
        res.json({
            weekly: weeklyData,
...
// ============================================
router.get('/notifications', auth_1.authMiddleware, auth_1.adminMiddleware, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
router.put('/notifications/:id/read', auth_1.authMiddleware, auth_1.adminMiddleware, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
...
// ============================================
router.post('/update-credentials', auth_1.authMiddleware, auth_1.adminMiddleware, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    try {
        ...
        if (newEmail && newEmail !== user.email) {
            ...
            const existingUser = yield prisma.user.findUnique({ where: { email: newEmail } });
        ...
        if (newPassword) {
            updateData.password = yield bcrypt.hash(newPassword, 10);
        }
